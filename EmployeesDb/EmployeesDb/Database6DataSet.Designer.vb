...
Partial Public Class Database6DataSet
    ...
    Partial Public Class EmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployeeRow(ByVal Employee_id As Integer, ByVal Firstname As String, ByVal Lastname As String, ByVal Age As Integer) As EmployeeRow
            Dim rowEmployeeRow As EmployeeRow = CType(Me.NewRow,EmployeeRow)
            Dim columnValuesArray() As Object = New Object() {Employee_id, Firstname, Lastname, Age}
...
Namespace Database6DataSetTableAdapters
    ...
    Partial Public Class EmployeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Employee` WHERE ((`Employee_id` = ?) AND ((? = 1 AND `Firstname` IS "& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Employee` (`Employee_id`, `Firstname`, `Lastname`, `Age`) VALUES (?,"& _ 
                " ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Employee` SET `Employee_id` = ?, `Firstname` = ?, `Lastname` = ?, `Age` ="& _ 
                " ? WHERE ((`Employee_id` = ?) AND ((? = 1 AND `Firstname` IS NULL) OR (`Firstnam"& _ 
                "e` = ?)) AND ((? = 1 AND `Lastname` IS NULL) OR (`Lastname` = ?)) AND ((? = 1 AN"& _ 
                "D `Age` IS NULL) OR (`Age` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.EmployeesDb.My.MySettings.Default.Database6ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Employee_id, Firstname, Lastname, Age FROM Employee"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Employee_id As Global.System.Nullable(Of Integer), ByVal Original_Firstname As String, ByVal Original_Lastname As String, ByVal Original_Age As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Employee_id As Global.System.Nullable(Of Integer), ByVal Firstname As String, ByVal Lastname As String, ByVal Age As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Employee_id As Global.System.Nullable(Of Integer), ByVal Firstname As String, ByVal Lastname As String, ByVal Age As Global.System.Nullable(Of Integer), ByVal Original_Employee_id As Global.System.Nullable(Of Integer), ByVal Original_Firstname As String, ByVal Original_Lastname As String, ByVal Original_Age As Global.System.Nullable(Of Integer)) As Integer
            If (Employee_id.HasValue = true) Then
            ...
            End If
            If (Original_Employee_id.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_Employee_id.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Firstname As String, ByVal Lastname As String, ByVal Age As Global.System.Nullable(Of Integer), ByVal Original_Employee_id As Global.System.Nullable(Of Integer), ByVal Original_Firstname As String, ByVal Original_Lastname As String, ByVal Original_Age As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_Employee_id, Firstname, Lastname, Age, Original_Employee_id, Original_Firstname, Original_Lastname, Original_Age)
        End Function
    End Class
